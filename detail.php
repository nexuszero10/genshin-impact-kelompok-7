        ...
        <div id="infoList">
            <div class="sub-List">
                <div class="infoContent">
                    <img src="image/karakter/card/logo-karakter.png" alt="logoKarakter">
                    <h2>KARAKTER</h2>
                    <p>Karakter memiliki base elemen, skill, dan role masing masing yang unik</p>
                    <div class="infoButton">
                        <a href="info-karakter.php"><button>Detail info</button></a>
                    </div>
                </div>

                <div class="infoContent">
                    <img src="image/elemental/hydro.png" alt="logoElemental">
                    <h2>ELEMENTAL</h2>
                    <p>Ada 7 elemntal yang mewakili unsur - unsur alam yang bisa bereaksi menghasilkan beebrapa elemntal reaction</p>
                    <div class="infoButton">
                        <a href="info-elemental.php"><button>Detail info</button></a>
                    </div>
                </div>

                <div class="infoContent">
                    <img src="image/weapon/logo-weapon.png" alt="logoWeapon">
                    <h2>WEAPON</h2>
                    <p>Weapon bersinergi dengan elemental milik karakter untuk meningkatkan skill aktif dan efek unik</p>
                    <div class="infoButton">
                        <a href="info-weapon.php"><button>Detail info</button></a>
                    </div>
                </div>

                <div class="infoContent">
                    <img src="image/artifact/logo-artifact.png" alt="logoArtifact">
                    <h2>ARTIFACT</h2>
                    <p>Artifact bersinergi dengan elemental milik karakter untuk menigkatkan base atribute milik karakter</p>
                    <div class="infoButton">
                        <a href="info-artifact.php"><button>Detail info</button></a>
                    </div>
                </div>
            </div>
        </div>
